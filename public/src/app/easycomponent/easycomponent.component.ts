...
@Component({
  selector: 'app-easycomponent',
  templateUrl: './easycomponent.component.html',
  styleUrls: ['./easycomponent.component.css']
})
export class EasycomponentComponent implements OnInit {
  allQuizzes: any;
  quiz: any;
  allTerms: any;
  term: any;
  ...
  getAllTermsFromThisQuiz(quiz){//#3
    ...
    let obs = this._httpService.getAllEasyTermsFromThisQuiz(quiz);
    obs.subscribe(data => {
      console.log(data);
