...
@Component({
  selector: 'app-hardcomponent',
  templateUrl: './hardcomponent.component.html',
  styleUrls: ['./hardcomponent.component.css']
})
export class HardcomponentComponent implements OnInit {
  allQuizzes: any;
  quiz: any;
  allTerms: any;
  term: any;
  ...
  getAllTermsFromThisQuiz(quiz){//#3
    ...
    let obs = this._httpService.getAllHardTermsFromThisQuiz(quiz);
    obs.subscribe(data => {
      console.log(data);
